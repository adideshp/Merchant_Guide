...
public class State_V extends Roman_State implements Roman_State_Interface{
	public State_V() {
		this.roman_value='V';
		this.value = 5;
	...
	public boolean is_transition_allowed(Roman_State next_state) {
		//V can never be repeated. Just one occurrence is allowed
		//V can never be subtracted i.e larger values are not allowed after V
		if(next_state.get_roman_value() == 'I') {return true;}
		return false;		
	}
}
